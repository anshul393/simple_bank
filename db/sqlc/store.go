...
// Store provides all the functionality to run database queries and transaction
type Store struct {
	*Queries
	db *sql.DB
}
...
// It creates transfer record, account entries and update the account's balances in a single transaction
